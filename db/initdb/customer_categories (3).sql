...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 11, 2021 at 05:27 AM
...
INSERT INTO `cc_customer` (`c_id`, `c_name`, `c_lname`, `c_address`, `t_id`, `c_tel`, `c_map`, `pv_id`) VALUES(1, '1', 'รรรร', 'dd', 2, '0852147963', NULL, '36000');
...
INSERT INTO `cc_employee` (`e_id`, `e_name`, `e_lname`, `ps_id`, `e_address`, `e_tel`, `e_username`, `e_password`, `pv_id`) VALUES(1234567, 'admin', 'admin', 1, 'chaiyaphum cpm', '0852114119', 'admin', '21232f29a57a5a73894a0ea801fc3', '36000');
...
INSERT INTO `cc_equipment` (`eq_id`, `p_id`, `c_id`, `e_id`, `eq_date_install`, `eq_amount`, `eq_des`, `pv_id`, `eq_code`, `eq_price`, `eq_discount`, `eq_base`, `eq_date_y`, `eq_date_m`, `eq_date_d`) VALUES(1, 1, 1, 1234567, '2021-06-01', NULL, '-', NULL, '4485j0003', '1000', 0, 10000, '2021', '06', '01');
...
INSERT INTO `cc_equip_status` (`eqs_id`, `s_id`, `eq_id`, `e_id`, `eqs_date`) VALUES(20, 1, 1, 1234567, '2021-06-10 07:55:46');
...
INSERT INTO `cc_position` (`ps_id`, `ps_name`, `ps_des`) VALUES(1, 'วิศวกร1', 'วิศวกรระดับ1');
INSERT INTO `cc_position` (`ps_id`, `ps_name`, `ps_des`) VALUES(2, 'วิศวกร2', 'วิศวกรระดับ2');
INSERT INTO `cc_position` (`ps_id`, `ps_name`, `ps_des`) VALUES(4, 'เจ้าหน้าที่ 1', 'เจ้าหน้าที่ปฏิบัติงาน 1');
INSERT INTO `cc_position` (`ps_id`, `ps_name`, `ps_des`) VALUES(6, 'เจ้าหน้าที่ 2', '222');
...
INSERT INTO `cc_product` (`p_id`, `p_name`, `p_detail`, `p_serial_number`, `p_buy`, `p_sell`, `pv_id`, `p_amount`) VALUES(1, 'OLA', NULL, NULL, 0, 0, '36000', NULL);
...
INSERT INTO `cc_province` (`pv_id`, `pv_name`, `pv_des`) VALUES('36000', 'ชัยภูมิ', '');
INSERT INTO `cc_province` (`pv_id`, `pv_name`, `pv_des`) VALUES('30000', 'นครราสีมา', '');
...
INSERT INTO `cc_type` (`t_id`, `t_name`, `t_des`) VALUES(2, 'ทั่วไป', '...');
INSERT INTO `cc_type` (`t_id`, `t_name`, `t_des`) VALUES(3, 'VIP', '');
...
--
ALTER TABLE `cc_equipment`
  MODIFY `eq_id` int(7) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `cc_equip_status`
--
ALTER TABLE `cc_equip_status`
  MODIFY `eqs_id` int(7) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;
...
--
ALTER TABLE `cc_product`
  MODIFY `p_id` int(7) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
